...
plugin.tx_azgrdownloadcenter_downloadcenter {
  ...
  settings {
    ...
    includejQuery = 0
    # cat=plugin.tx_azgrdownloadcenter_downloadcenter/settings; type=string; label=Filemount
    filemount = fileadmin/
	# cat=plugin.tx_azgrdownloadcenter_downloadcenter/settings; type=string; label=Upload directory
    uploadDir = zip/
    # cat=plugin.tx_azgrdownloadcenter_downloadcenter/settings; type=string; label=Zip file prefix
    zipPrefix = downloads-
    # cat=plugin.tx_azgrdownloadcenter_downloadcenter/settings; type=string; label=Zip directory
    zipDir = Downloads
    # cat=plugin.tx_azgrdownloadcenter_downloadcenter/settings; type=string; label=Always add following files (comma-separated id)
    filesDefault = 
    # cat=plugin.tx_azgrdownloadcenter_downloadcenter/settings; type=int+; label=Lifespan of files in days
    ttl = 1
  }
}
